...
class GoreManagerAboutDialog extends StatefulWidget {
  const GoreManagerAboutDialog({super.key});

  @override
  State<GoreManagerAboutDialog> createState() => _GoreManagerAboutDialogState();
}

class _GoreManagerAboutDialogState extends State<GoreManagerAboutDialog> {
