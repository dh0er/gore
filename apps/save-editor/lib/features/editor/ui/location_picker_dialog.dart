...
class _LocationPickerDialogState extends ConsumerState<_LocationPickerDialog> {
  ...
  /// Localized area name. Delegates to the shared [localizedAreaLabel] so this
  /// dialog and the locks panel, which group by the same area codes, can never
  /// name the same area differently.
  String _areaLabel(
    String areaId,
  ...
  ) => localizedAreaLabel(areaId, catalog, locCatalog, lang, l10n);
