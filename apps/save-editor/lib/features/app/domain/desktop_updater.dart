...
/// is false or the user disabled automatic checks.
///
...
/// "you're up to date" case. Works even while automatic checks are off.
...
/// Applies the auto-check setting at runtime: interval 0 stops WinSparkle's
/// scheduled checks; re-enabling restores the interval and checks once.
