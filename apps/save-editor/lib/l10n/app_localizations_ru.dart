...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get editorInventorySlotRepairConflict =>
      'В очереди одновременно восстановление слотов и прямое изменение идентификатора слота. Восстановление перезаписывает все идентификаторы и отменит прямое изменение — отмените одно из них и сохраните снова.';
}
