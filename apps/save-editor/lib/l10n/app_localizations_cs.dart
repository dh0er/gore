...
class AppLocalizationsCs extends AppLocalizations {
  ...
  String glossaryCatalogSegmentLabel(String segmentId, String fallback) {
    String _temp0 = intl.Intl.selectLogic(segmentId, {
      ...
      'FiskNewDealer': 'Nový překupník pro Fiska',
      'FiskNewDealerCompleted': 'Nový překupník pro Fiska — dokončeno',
      'FogTower': 'Mlžná věž',
      'Food': 'Jídlo',
      'Forgave': 'Odpustil',
      'Forgive': 'Odpustit',
      ...
      'Lockpick': 'Paklíč',
      'Mad': 'Šílený',
      'Mandibles': 'Kusadla důlního lezce',
      'MapMaker': 'Tvůrce map',
      'Monastery': 'Klášter',
      ...
      'TeachIchor': 'Učit extrakci ichoru důlních lezců',
