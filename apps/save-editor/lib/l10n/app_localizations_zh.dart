...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String attributeManualTooltip(String attributeId) {
    String _temp0 = intl.Intl.selectLogic(attributeId, {
      'SuperArmor': '主角在被一击打得踉跄之前还能扛下多少打击。',
      'MaxSuperArmor': '霸体值的上限，会随着等级提升和所穿的护甲一起增长。',
      'DamageMultiplier': '作用于主角所受伤害的系数——1 为正常，数值越高越吃痛。',
      'SpeedModifier': '主角移动快慢的系数——1 为正常。',
      'Oxygen': '水下剩余的呼吸秒数，归零时主角就会淹死。',
      'MaxOxygen': '主角能在水下待多少秒，潜水技能可以提高这个上限。',
      ...
      'Alcohol': '主角醉到什么程度，较高的档位会拿敏捷和法力去换力量。',
      'MaxAlcohol': '主角能达到的最高酒精值。',
