...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String glossaryCatalogSegmentLabel(String segmentId, String fallback) {
    String _temp0 = intl.Intl.selectLogic(segmentId, {
      ...
      'FiskNewDealer': 'Новий збирач для Fisk',
      'FiskNewDealerCompleted': 'Новий збирач для Fisk — завершено',
      ...
      'TeachIchor': 'Навчити добутку іхору рудокопів',
