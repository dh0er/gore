...
class GoreStudioAboutDialog extends StatefulWidget {
  const GoreStudioAboutDialog({super.key});

  @override
  State<GoreStudioAboutDialog> createState() => _GoreStudioAboutDialogState();
}

class _GoreStudioAboutDialogState extends State<GoreStudioAboutDialog> {
      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/gore_studio_icon.png', height: 120),
              ...
              FutureBuilder<PackageInfo>(
                ...
                builder: (context, snapshot) {
                  ...
                  final version = info == null
                      ? ''
                      : l10n.aboutVersion(info.version, _gitSha);
