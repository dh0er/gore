...
/// gore-mod shares gore-save's visual language (teal/gold on a slate surface)
/// so the two desktop tools feel like one suite. Kept in sync with
/// gore-save's `ui/design/app_theme.dart`.
ThemeData buildGoreModTheme() => _buildTheme(Brightness.light);

ThemeData buildGoreModDarkTheme() => _buildTheme(Brightness.dark);
