...
void main() {
  ...
  test('scriptCompileFresh tracks the compiled .as content', () {
    ...
    final asFile = File('${dir.path}/Mod.as')
      ..writeAsStringSync('void main() {}');
    final mini = File('${dir.path}/Mod.cache')
      ..writeAsStringSync('compiled-bytes');
  ...
  test(
    'mods sharing a moduleName but differing in relPath coexist (keyed by relPath)',
    () {
      final n = ScriptModsNotifier();
