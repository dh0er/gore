...
use gore_authoring::{
    Revision3ExactSnapshotExportErrorV1, Revision3ExactSnapshotExportPublicationV1, WorkingHead,
    WorkingProjectStore, WorkingStoreError, WorkingStoreLimits,
    REVISION3_EXACT_SNAPSHOT_ARTIFACT_KIND_V1, REVISION3_EXACT_SNAPSHOT_EXPORT_FORMAT_V1,
    REVISION3_EXACT_SNAPSHOT_MANIFEST_FILE_V1, REVISION3_EXACT_SNAPSHOT_RESTORE_STATUS_V1,
};
...
mod tests {
    ...
    use gore_authoring::{
        ...
        Revision3ExactSnapshotExportV1, Sha256Digest, WorkingProjectStore, WorkingStoreLimits,
    };
    use serde_json::json;
