...
use crate::{
    BoundedString, MAX_STORY_BUILD_DIAGNOSTIC_MESSAGE_BYTES,
    MAX_STORY_BUILD_GENERATOR_ID_BYTES, MAX_STORY_BUILD_PROPERTY_PATH_BYTES,
};
...
struct PlanWire {
    ...
    scope: NpcInspectionScopeV1,
    source_status: NpcInspectionSourceStatusV1,
    compiler_status: NpcInspectionCompilerStatusV1,
    build_status: NpcInspectionBuildStatusV1,
    runtime_qualification: NpcInspectionRuntimeQualificationV1,
    spawn_status: NpcInspectionSpawnStatusV1,
    publication_status: NpcInspectionPublicationStatusV1,
    provenance: Revision3NpcInspectionProvenanceV1,
    npc: Revision3NpcInspectionEntityV1,
    module: Revision3NpcInspectionModuleV1,
    diagnostics: Vec<Revision3NpcInspectionDiagnosticV1>,
}
...
impl From<PlanWire> for Revision3NpcSourceInspectionPlanV1 {
    fn from(wire: PlanWire) -> Self {
        Self {
            ...
            scope: wire.scope,
            source_status: wire.source_status,
            compiler_status: wire.compiler_status,
            build_status: wire.build_status,
            runtime_qualification: wire.runtime_qualification,
            spawn_status: wire.spawn_status,
