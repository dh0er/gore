...
pub const CATEGORY_ORDER: &[&str] = &[
    "Combat", "Crafting", "Hunting", "Language", "Magic", "Movement", "Thievery",
];
...
pub const SKILLS: &[SkillDef] = &[
    ...
    SkillDef {
        base: "Hunting_Secretion",
        label: "Take Secretion",
        category: "Hunting",
        kind: Kind::Hunting,
        ladder: NO_TIERS,
        has_untrained: false,
    ...
    SkillDef {
        base: "Hunting_SkullArmor",
        label: "Take Skull Plates",
        category: "Hunting",
        kind: Kind::Hunting,
        ladder: NO_TIERS,
        has_untrained: false,
    ...
    SkillDef {
        base: "Hunting_SkinSwampshark",
        label: "Skin Swampshark",
        category: "Hunting",
        kind: Kind::Hunting,
        ladder: NO_TIERS,
        has_untrained: false,
    ...
    SkillDef {
        base: "Hunting_MCPlate",
        label: "Take Minecrawler Plates",
        category: "Hunting",
        kind: Kind::Hunting,
        ladder: NO_TIERS,
        has_untrained: false,
    ...
    SkillDef {
        base: "Hunting_TeethSwampshark",
        label: "Extract Shark Teeth",
        category: "Hunting",
        kind: Kind::Hunting,
        ladder: NO_TIERS,
        has_untrained: false,
    ...
    SkillDef {
        base: "Hunting_TongueOfFire",
        label: "Take Fire Tongue",
        category: "Hunting",
        kind: Kind::Hunting,
        ladder: NO_TIERS,
        has_untrained: false,
    ...
    SkillDef {
        base: "Hunting_TrollHorn",
        label: "Take Troll Horn",
        category: "Hunting",
        kind: Kind::Hunting,
        ladder: NO_TIERS,
        has_untrained: false,
