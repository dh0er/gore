...
pub const PINNED_STEAM_APP_ID: u32 = 1_297_900;
pub const PINNED_STEAM_BUILD_ID: u64 = 24_539_464;
pub const PINNED_ANGELSCRIPT_VERSION: u32 = 23_300;
pub const PINNED_EXECUTABLE_BYTES: u64 = 171_784_704;
pub const PINNED_PE_SIZE_OF_IMAGE: u32 = 0x0a7e_4000;
pub const PINNED_EXECUTABLE_SHA256: [u8; 32] = [
    0xc7, 0x1c, 0x04, 0xdd, 0x86, 0xe1, 0x1e, 0x3e, 0x94, 0x48, 0x3e, 0xa0, 0x2c, 0x26, 0xc6, 0x12,
    0xb6, 0x24, 0x3c, 0x14, 0x7f, 0x6d, 0x83, 0x97, 0x32, 0x33, 0xb3, 0xc8, 0xdd, 0xc5, 0xde, 0x25,
];
/// Raw sixteen bytes following `RSDS`, not a host-endian GUID structure.
pub const PINNED_CODEVIEW_GUID_RSDS: [u8; 16] = [
    0xbd, 0x83, 0x0b, 0xcf, 0x23, 0xe0, 0x1b, 0x06, 0x21, 0x00, 0x0f, 0x0f, 0xcc, 0xf8, 0x71, 0xd2,
];
pub const PINNED_CODEVIEW_AGE: u32 = 1;
pub const PINNED_BUILD_IDENTIFIER: u32 = 0x9e37_7abe;
/// Raw bytes serialized for the current `PrecompiledScript_Shipping.Cache` FGuid.
pub const PINNED_PRECOMPILED_GUID: [u8; 16] = [
    0xbe, 0x78, 0xfe, 0x0a, 0x46, 0xac, 0x66, 0x43, 0x96, 0x85, 0x97, 0xe8, 0x5c, 0x7e, 0x5b, 0x3f,
];

pub const RVA_SET_ENGINE_PROPERTY: u32 = 0x47a_50f0;
pub const RVA_BIND_CALLBACK_CALL: u32 = 0x468_56fb;
pub const RVA_BIND_CALLBACK_RETURN: u32 = 0x468_56fd;
pub const RVA_GET_BUILD_IDENTIFIER: u32 = 0x48d_3230;
pub const RVA_GET_STATIC_JIT_INFO: u32 = 0x48d_0f60;
pub const RVA_INITIAL_COMPILE_ENTER: u32 = 0x468_4210;
pub const RVA_PRECOMPILED_DESCRIPTORS_REQUESTED: u32 = 0x468_42d0;
pub const RVA_PREPROCESSOR_CONSTRUCTED: u32 = 0x468_435d;
pub const RVA_INITIAL_COMPILE_RETURN: u32 = 0x468_5a46;
