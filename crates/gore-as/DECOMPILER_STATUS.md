...
**Status: every module decompiles, the whole tree recompiles, and 98.31% of it is byte-faithful.**
...
| Byte-faithfulness (`bytediff --norm-slots`) | full corpus, 164,607 functions | **98.31%** (`IDENTICAL`+`BENIGN`) |
...
**2,787 functions (1.69%) recompile to bytecode that differs semantically.** A semantic
