...
**Status: every module decompiles, the whole tree recompiles, and 98.37% of it is byte-faithful.**
...
| Byte-faithfulness (`bytediff --norm-slots`) | full corpus, 164,607 functions | **98.37%** (`IDENTICAL`+`BENIGN`) |
...
**2,679 functions (1.63%) recompile to bytecode that differs semantically.** A semantic
