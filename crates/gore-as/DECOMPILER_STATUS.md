...
**Status: every module decompiles, the whole tree recompiles, and 98.38% of it is byte-faithful.**
...
| Byte-faithfulness (`bytediff --norm-slots`) | full corpus, 164,607 functions | **98.38%** (`IDENTICAL`+`BENIGN`) |
...
**2,662 functions (1.62%) recompile to bytecode that differs semantically.** A semantic
