...
**1,116 functions (0.68%) recompile to bytecode that differs semantically.** A semantic
...
the remaining 1,116 are made of.
...
continue-only loop scope, and the declaration-order rules — down to the **1,116** the headline
reports.
