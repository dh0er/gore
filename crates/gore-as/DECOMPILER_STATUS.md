...
**1,126 functions (0.68%) recompile to bytecode that differs semantically.** A semantic
...
the remaining 1,126 are made of.
...
continue-only loop scope, and the declaration-order rules — down to the **1,126** the headline
reports.
