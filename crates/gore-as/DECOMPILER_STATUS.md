...
**Status: every module decompiles, the whole tree recompiles, and 98.85% of it is byte-faithful.**
...
| Byte-faithfulness (`bytediff --norm-slots`) | full corpus, 164,607 functions | **98.85%** (`IDENTICAL`+`BENIGN`) |
