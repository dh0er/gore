...
/// m_ItemDefinition. Regenerated by projects/gore-core/pipeline/build_item_catalog.py.
const ITEM_CATALOG_JSON: &str = include_str!("../../../projects/gore-save/app/assets/item_catalog.json");
