...
pub use working_store::{
    ...
    Revision3ExactSnapshotExportV1, Revision3ExactSnapshotExportWarningV1, Revision3HistoryEntryV1,
    Revision3HistoryErrorV1, Revision3HistoryV1, Revision3SnapshotManifest, WorkingHead,
    ...
    MAX_REVISION3_HISTORY_PARENT_RECORDS_V1, REVISION3_EXACT_SNAPSHOT_ARTIFACT_KIND_V1,
