...
use gore_authoring::{
    ...
    MAX_DRAFT_QUEST_OBJECTIVES, MAX_DRAFT_QUEST_OBJECTIVE_TITLE_BYTES, MAX_DRAFT_QUEST_TITLE_BYTES,
    MAX_PROJECT_JSON_BYTES, MAX_REVISION3_QUEST_OUTLINE_EDIT_DISPLAY_NAME_BYTES_V1,
...
fn attach_transcript(
    ...
    project.entities.insert(
        ...
        Revision3Entity {
            id: localization_id,
            display_name: "Outline-preserved transcript text".to_owned(),
            origin: Revision3OriginRef::New {
                authored_runtime_id: "GORE_OUTLINE_TRANSCRIPT_LOC_ENTITY".to_owned(),
            },
            revision: 2,
            payload: Revision3EntityPayload::LocalizationEntry(Revision2LocalizationEntry {
                loc_id: "GORE_OUTLINE_TRANSCRIPT_TEXT".to_owned(),
                texts: BTreeMap::new(),
            }),
        },
    );
    project.entities.insert(
        ...
        Revision3Entity {
            id: line_id,
            display_name: "Outline-preserved transcript line".to_owned(),
            origin: Revision3OriginRef::New {
...
fn exact_edit_changes_only_outline_module_and_three_revisions() {
    ...
    let Revision3EntityPayload::QuestDraft(edited_quest) =
        &outcome.project.entities[&id(0x21)].payload
    else {
