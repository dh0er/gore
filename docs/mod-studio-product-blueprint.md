...
flows; the canonical eight-destination shell appears after managed adoption.
...
Build & Release, and Settings & Expert destinations. DataAssets is a Content
...
Current implementation note: the managed shell implements all eight primary
