...
Silence is the good case: **7,076 of the 7,317 modules recompile with no known semantic
...
The remaining 241 differ only in spelling — same program, different text. The loops that once
