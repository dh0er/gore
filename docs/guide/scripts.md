...
Silence is the good case: **7,067 of the 7,317 modules recompile with no known semantic
...
The remaining 250 differ only in spelling — same program, different text. The loops that once
