...
Silence is the good case: **7,079 of the 7,317 modules recompile with no known semantic
...
The remaining 238 differ only in spelling — same program, different text. The loops that once
