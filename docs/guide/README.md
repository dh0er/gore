...
| [Reading dialog trees](dialog-trees.md) | `gore dialog`: what an NPC says, what unlocks it, which menu it sits in |
...
| Page | What it covers |
|---|---|
| [Dialog authoring](dialog-authoring.md) | Write a compiled dialog topic and get it into the game |
