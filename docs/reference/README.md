...
| [Dialog runtime internals](dialog-runtime.md) | The proven runtime boundary for compiled dialog topics, anchored first conversations, all-new trees and selective multi-module caches; plus requalification, hook order and current limits. |
